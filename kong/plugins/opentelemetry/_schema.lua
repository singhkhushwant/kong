          ...
          fields = {
            ...
            },
            {
              batch_span_count = {
                ...
                deprecation = {
                  message =
                  "opentelemetry: config.batch_span_count is deprecated, please use config.queue.max_batch_size instead",
            ...
            },
            {
              batch_flush_delay = {
                ...
                deprecation = {
                  message =
                  "opentelemetry: config.batch_flush_delay is deprecated, please use config.queue.max_coalescing_delay instead",
                  removal_in_version = "4.0",
                  old_default = 3,
                },
              },
            ...
            { read_timeout = typedefs.timeout { default = 5000 } },
            {
              http_response_header_for_traceid = {
                description =
                "Specifies a custom header for the `trace_id`. If set, the plugin sets the corresponding header in the response.",
                type = "string",
                default = nil
              }
            },
            {
              header_type = {
                ...
                deprecation = {
                  message =
                  "opentelemetry: config.header_type is deprecated, please use config.propagation options instead",
                  removal_in_version = "4.0",
